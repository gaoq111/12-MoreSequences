...
def main():
    ...
    #   unt#il you get to TO DO 9 and 10.
    # ------------------------------------------------------------------
...
def run_test_make_less_simple_string():
    ...
    print()
    expected = '305'
    actual = make_less_simple_string(305,305)
    print('Test 2')
    print()
    print('Expected is', expected)
    print('Actual is  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        p.append(rg.Rectangle(rg.Point(circles[k].center.x-circles[k].radius,circles[k].center.y-circles[k].radius),
